<template>
    <div class="flex flex-col flex-1 items-center ">
        ...
        <div class="border-white border-opacity-10 border">
            <!-- hourly weather -->
                    ...
                    <div class="flex gap-10 overflow-x-auto">
                        <div v-for="hourData in weatherData.hourly" :key="hourData.dt" class="flex flex-col gap-4 items-center">
                            <p class="whitespace-nowrap text-md">
                                {{
                                    new Date(hourData.currentTime).toLocaleDateString("en-us",{hour:"numeric"})
                                }}
                            </p>
                            <img 
            ...
            <div class="flex justify-center items-center gap-2 py-12 text-white cursor-pointer duration-150 hover:text-red-300" @click="RemoveCity">
